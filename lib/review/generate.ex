defmodule Review.Generate do
  ...
  def main(args) do
    ...
    review_dir = Review.Common.Config.review_dir(root)
    ...
    files = SourceSet.files(root, args, review_dir, source_blacklist, source_dirs)
  ...
  def discover_source_files(
    ...
    SourceSet.discover_source_files(root, review_dir, source_blacklist, source_dirs)
  end
